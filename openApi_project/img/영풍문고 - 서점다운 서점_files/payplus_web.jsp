...
/******************************************************************************
// Title	: 접속 브라우저 쿼크모드 체크 ( PGWEBDEV-151 미사용함수 )
// Date		: 2015.12.15
// By		: ktw
******************************************************************************/
...
{
    // PGWEBDEV-415 플러그인 종료에 따른 EXE 호출 방지
	DO_KCP_DefaultExecute(payform.pay_method.value, payform);
}


/******************************************************************************
// Title	: form 의 KCP_PAY_MODULE 값에 따른 결제창 연동 ( PGWEBDEV-415 미사용함수 )
// Return	: boolean
// Date		: 2015.12.15
// By		: ktw
******************************************************************************/
...
/******************************************************************************
// Title	: NPay pay_method 결제창 분기 로직 ( PGWEBDEV-415 미사용함수 )
// Date		: 2016.08.08
// By		: ktw
******************************************************************************/
